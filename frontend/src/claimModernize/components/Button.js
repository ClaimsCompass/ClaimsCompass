...
export const ActionButton= () => {
    ...
    const redirectDashboard = async () => {
        ...
        try {
            ...
            const updateClaimPost = 'https://claims-compass-cors-b01090e891ae.herokuapp.com/http://ec2-3-21-119-123.us-east-2.compute.amazonaws.com:8080/api/updateProcessedClaim';
